...
import { getProductsFromAPI, createTransaction } from '../api/api';
            ...
            <div className="p-6 border-t border-gray-100 bg-gray-50 rounded-b-3xl">
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-amber-600 text-white font-bold rounded-full hover:bg-amber-700 transition-all duration-200 shadow-lg hover:shadow-xl active:scale-[0.98] disabled:bg-gray-400 disabled:cursor-not-allowed disabled:transform-none"
                >
                  {isCheckoutLoading ? (
                    <>
