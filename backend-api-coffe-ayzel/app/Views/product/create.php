            ...
            <div class="card-body">
                ...
                <form action="/product/store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= (validation_show_error('nama')) ? 'is-invalid' : ''; ?>" id="nama" name="nama" value="<?= old('nama'); ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?= (validation_show_error('deskripsi')) ? 'is-invalid' : ''; ?>" id="deskripsi" name="deskripsi" rows="4"><?= old('deskripsi'); ?></textarea>
                        <div class="invalid-feedback">
